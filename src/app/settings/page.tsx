    ...
    <>
      ...
      <div className="settings-grid">
        <Section title="运行状态" description="只显示技术状态，不读取或展示个人记录。">
          ...
          <div className="settings-row"><div><strong>当前版本</strong><small>秋招进度板 · 简历库 MVP</small></div><StatusPill tone="accent">v{health?.appVersion ?? "0.2.0"}</StatusPill></div>
        </Section>
        ...
        <Section title="当前可用" description="这是一条精简但完整的本地推进闭环。">
          <ul className="plain-list"><li>申请、阶段和三种推进状态</li><li>面试、笔试、截止与复查事件</li><li>DOCX / PDF 简历版本库与投递版本关联</li><li>带浏览器临时草稿恢复的申请备注</li><li>今日风险队列、看板 / 表格和日程列表</li><li>单个事件、当前列表与全部未来事件的 ICS 导出</li><li>不可直接编辑的申请时间线</li></ul>
        </Section>

        <Section title="后续提供" description="下列能力尚未开启，界面不会暗示它们已经可用。">
          <ul className="plain-list muted"><li>JD 与面经资料库</li><li>应用内简历编辑或 AI 优化</li><li>表格导入、完整备份与恢复脚本</li><li>PWA、浏览器通知与 AI</li><li>浏览器草稿不是离线正式编辑或跨设备同步</li></ul>
        </Section>
